...
function toggleTheme() {
  ...
  if (isDarkMode) {
    ...
    logo.src = "assets/pixelcraft_yellow_dark.png";
  } else {
    // Apply light mode
    document.documentElement.classList.add("light-mode");
    localStorage.setItem("theme", "light"); // Save theme preference

    logo.src = "assets/pixelcraft_yellow_light.png";
  }
}
...
const swiperWeboldal2 = new Swiper(".swiper-grafika", {
  slidesPerView: "auto",
  slidesOffsetBefore: 20,
  spaceBetween: 20,
  navigation: {
    nextEl: ".swiper-button-next-grafika",
    prevEl: ".swiper-button-prev-grafika",
  },
  loop: true,
});
