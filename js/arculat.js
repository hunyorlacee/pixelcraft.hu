...
function toggleTheme() {
  ...
  if (isDarkMode) {
    ...
    logo.src = "assets/pixelcraft_purple_dark.png";
  } else {
    // Apply light mode
    document.documentElement.classList.add("light-mode");
    localStorage.setItem("theme", "light"); // Save theme preference

    logo.src = "assets/pixelcraft_purple_light.png";
  }
}
...
const swiperWeboldal2 = new Swiper(".swiper-arculat", {
  slidesPerView: "auto",
  slidesOffsetBefore: 20,
  spaceBetween: 20,
  navigation: {
    nextEl: ".swiper-button-next-arculat",
    prevEl: ".swiper-button-prev-arculat",
  },
  loop: true,
});
